...
const criteria = [
  ...
  { k: "04", title: "A valuable solution", body: "The solution addresses a large market or critical infrastructure need — a gap customers will pay meaningfully to close." },
